...
{
    ChimpRef *obj = chimp_object_call (chimp_str_class, chimp_array_new (NULL));
...
{
    ChimpRef *obj = chimp_object_call (chimp_str_class, chimp_array_new_var (NULL, CHIMP_STR_NEW (NULL, "testing"), NULL));
...
{
    ChimpRef *obj = chimp_object_call (chimp_str_class, chimp_array_new_var (NULL, chimp_int_new (NULL, 4096), NULL));
