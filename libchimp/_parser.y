...
%{
extern int yylex(YYSTYPE *lvalp, YYLTYPE *llocp, void *scanner, ChimpRef *filename, ChimpRef **mod);
%}
...
void
yyerror (const ChimpAstNodeLocation *loc, void *scanner, ChimpRef *filename, ChimpRef **mod, const char *format, ...)
{
    va_list args;
